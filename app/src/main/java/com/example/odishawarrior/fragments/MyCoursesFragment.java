...
import static com.example.odishawarrior.classes.UserDetailsVariables.TYPE_COURSES;
...
public class MyCoursesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MainActivity.currently_present_on_fragment = TYPE_COURSES;



        recyclerView = view.findViewById(R.id.courseFragRv);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        firestore.collection("USER").document(FirebaseAuth.getInstance().getUid()).
                collection("USER_DATA").document("MY_COURSES").get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            @Override
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.contains("my_purchases")) {
                        ...
                        Toast.makeText(getContext(), "2 No Courses PURCHASED", Toast.LENGTH_LONG).show();
                    }
