...
public class LecturesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.lecturesRecyclerView);
        ...
        firestore.collection("PURCHASEDPRODUCTS").document(CourseMaterialActivity.productId)
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    PurchasedMaterialsAdapter adapter = new PurchasedMaterialsAdapter(titleList, urlList, UserDetailsVariables.LECTURES);
